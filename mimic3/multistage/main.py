...
for diagnosis in diagnoses:
    ...
    loader_features_t1,loader_features_t2, loader_features_t3=map(lambda i:DataLoader(i,batch_size=1), features_datasets)
    loader_drug_t1,loader_drug_t2, loader_drug_t3=map(lambda i:DataLoader(i,batch_size=1), drug_datasets)
    ...
    optimizer = torch.optim.Adam(multistage_model.parameters(), lr=0.0001)
    ...
    for epoch in range(epochs):
        for i,((x1_t1,y11), (x2_t1,y21),(x1_t2,y12),(x2_t2,y22), (x1_t3,y),(x2_t3,y)) \
            ...
            #output
            lout=criterion(out,y)

            loss=((l11+l12+l21+l22+lout)/1) # one is batch size
